...
public class TestingGhostFollowOwnerGoal extends Goal {
    ...
    public TestingGhostFollowOwnerGoal(MainGhostEntity ghost, double maxSpeedModifier, double minDistance, double startDistance, float lerpFactor) {
        this.ghost = ghost;
