...
public class CalibratedHauntedEyeGlowRenderer implements BlockEntityRenderer<CalibratedHauntedEyeBlockEntity> {
    ...
    private void renderFrontGlow(PoseStack poseStack, MultiBufferSource buffers, int power, Direction frontDirection) {
        ...
        vertexConsumer.vertex(lastPose, x0, y0, z)
                .color(1f, 1f, 1f, 1f)
                .uv(u0, v1)
        ...
        vertexConsumer.vertex(lastPose, x0, y1, z)
                .color(1f, 1f, 1f, 1f)
                .uv(u0, v0)
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(fullBright)
        ...
        vertexConsumer.vertex(lastPose, x1, y1, z)
                .color(1f, 1f, 1f, 1f)
                .uv(u1, v0)
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(fullBright)
        ...
        vertexConsumer.vertex(lastPose, x1, y0, z)
                .color(1f, 1f, 1f, 1f)
                .uv(u1, v1)
                .overlayCoords(OverlayTexture.NO_OVERLAY)
                .uv2(fullBright)
