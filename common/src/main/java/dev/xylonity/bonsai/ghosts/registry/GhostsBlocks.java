...
public class GhostsBlocks {
    ...
    public static final Supplier<Block> HAUNTED_LEAVES = register("haunted_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_LEAVES).lightLevel(value -> 4)));
