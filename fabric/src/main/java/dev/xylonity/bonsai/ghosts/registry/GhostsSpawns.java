...
public class GhostsSpawns {
    ...
    public static void init() {
        ...
        SpawnPlacements.register(GhostsEntities.KODAMA.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, KodamaEntity::checkKodamaSpawnRules);
    }
