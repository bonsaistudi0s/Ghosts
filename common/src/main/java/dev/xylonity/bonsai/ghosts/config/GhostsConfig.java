...
public final class GhostsConfig {
    ...
    public static String GHOST_SPAWN = "8, 1, 2, #minecraft:is_forest";

    @ConfigEntry(
            comment = "Ghost spawnrate: [weight, minAmount, maxAmount, biomes and tags... (as many as you want)]"
    )
    public static String SMALL_GHOST_SPAWN = "8, 1, 2, minecraft:flower_forest, #minecraft:is_forest, #forge:is_swamp";

    @ConfigEntry(
            comment = "Kodama spawnrate: [weight, minAmount, maxAmount, biomes and tags... (as many as you want)]"
    )
    public static String KODAMA_SPAWN = "20, 1, 2, minecraft:birch_forest, minecraft:forest, minecraft:old_growth_spruce_taiga, minecraft:dark_forest";
